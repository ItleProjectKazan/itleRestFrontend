...
scp next-deploy.tar.gz itle@91.107.121.196:/tmp/
if errorlevel 1 (
...
ssh itle@91.107.121.196 "rm -rf /var/www/itle/itle-rest/.next/* && tar -xzf /tmp/next-deploy.tar.gz -C /var/www/itle/itle-rest/.next && rm /tmp/next-deploy.tar.gz"
if errorlevel 1 (
