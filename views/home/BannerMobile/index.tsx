...
const Slide: FC<SlideProps> = ({ banner }) => {
    ...
    // WARNING: separate variable is required
            ...
            ? (props: any) => {
                  return (
                      <div
                          ...
                          style={{
                              backgroundImage: `url(${banner.mobile_background_image || banner.background_image || '/images/product-image-placeholder.svg'})`,
                          }}
                      >
                          <Link href={url} {...props} />
                      </div>
    ...
    if (!isLoaded) {
                ...
                <Image
                    ...
                    src={
                        banner.background_image
                            ? banner.background_image
                            : '/images/atmosphere-comfort__slider1-image.png'
                    }
                    unoptimized
                />
            </SlideComponent>
        ...
        return (
            <SlideComponent
                className='main-banner__slide'
                // style={{ backgroundImage: `url(${banner.background_image ? banner.background_image : '/images/product-image-placeholder.svg'})` }}
                style={{
                    backgroundImage: `url(${banner.mobile_background_image || banner.background_image || '/images/atmosphere-comfort__slider1-image.png'})`,
                }}
            >
...
const Banner: FC<Props> = ({ banners }) => {
    return (
        <section className='main-banner mobile'>
